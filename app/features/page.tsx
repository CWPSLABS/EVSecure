        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mb-20">
            ...
            <p className="text-gray-400 text-center mb-12 max-w-2xl mx-auto">
              A quick guide for developers on integrating EnvVault exports into your projects
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    <h3 className="text-lg font-semibold text-white mb-2">Export from EnvVault</h3>
              ...
              <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-6 border border-slate-700/50">
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-400 mb-3">
                      ⚠️ <strong className="text-red-400">Critical:</strong> Never commit .env files to Git!
                    </p>
                  </div>
                </div>
                <div className="bg-slate-900/50 rounded-lg p-4 font-mono text-sm">
            ...
            <div className="mt-8 bg-gradient-to-r from-blue-500/10 to-purple-500/10 rounded-xl p-6 border border-blue-500/20">
              ...
              <ul className="space-y-3 text-sm text-gray-400">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 flex-shrink-0">🔄</span>
                  <span><strong className="text-white">Keep EnvVault updated:</strong> When values change, update in EnvVault and re-export</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-purple-500/10 to-blue-500/10 rounded-3xl p-12 border border-purple-500/20 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/setup"
                className="inline-flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-purple-500 to-blue-500 px-8 py-4 font-semibold text-white hover:from-purple-600 hover:to-blue-600 transition-all duration-200 shadow-lg shadow-purple-500/30 hover:shadow-purple-500/50 hover:scale-105"
              >
                Create Your Vault
      ...
      <footer className="relative py-12 bg-slate-950/50 mt-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-gray-500 text-sm">
            <p>© 2026 EnvVault. Your secrets stay yours.</p>
          </div>
        </div>
      </footer>
    </div>
