          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-wrap items-center gap-2 w-full sm:w-auto">
              ...
              {isActivePro && isCloudAuthenticated ? (
                ...
                <Link
                  href="/pricing"
                  className="flex items-center gap-2 px-3 py-2 bg-amber-500/10 border border-amber-500/50 rounded-lg hover:bg-amber-500/20 transition-colors"
                >
                  <svg className="w-4 h-4 text-amber-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
                  </svg>
                  <span className="text-xs text-amber-400 whitespace-nowrap">Upgrade for Sync</span>
                </Link>
              ) : (
                // Not signed in → show upgrade to pro
                <Link
                  href="/pricing"
                  className="flex items-center gap-2 px-3 py-2 bg-purple-500/10 border border-purple-500/50 rounded-lg hover:bg-purple-500/20 transition-colors"
                >
                  <svg className="w-4 h-4 text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 15a4 4 0 004 4h9a5 5 0 10-.1-9.999 5.002 5.002 0 10-9.78 2.096A4.001 4.001 0 003 15z" />
                  </svg>
                  <span className="text-xs text-purple-400 whitespace-nowrap">Upgrade to Pro</span>
                </Link>
              )}
