  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white">
        ...
        <div className="max-w-6xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-400">Secure Environment Manager</p>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              {isActivePro && isCloudAuthenticated ? (
                ...
                <div className="flex items-center gap-2 px-3 py-2 bg-amber-500/10 border border-amber-500/50 rounded-lg">
                  ...
                  <span className="text-xs text-amber-400">Cloud Sync Locked</span>
                </div>
              ) : null}
      ...
      <div className="max-w-6xl mx-auto px-6 py-8">
        ...
        {/* Page Header */}
        <div className="mb-8">
          <h2 className="text-3xl font-bold mb-2">Your Environments</h2>
          <p className="text-gray-400">Manage your environment variables securely</p>
        </div>
        ...
        {environments.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-400 mb-6">
              {error ? 'There was an error loading environments' : 'Your default environments will appear here after setup'}
            </p>
            <button
